...
/**
 * This is the item provider adapter for a {@link com.city.network.MLocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addLongitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_longitude_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_longitude_feature",
								"_UI_Location_type"),
						MNetworkPackage.Literals.LOCATION__LONGITUDE, true, false, false,
	...
	protected void addLatitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_latitude_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_latitude_feature",
								"_UI_Location_type"),
						MNetworkPackage.Literals.LOCATION__LATITUDE, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Location_type") + " " + location.getLongitude();
	}
