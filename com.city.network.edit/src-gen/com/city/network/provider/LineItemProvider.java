...
/**
 * This is the item provider adapter for a {@link com.city.network.MLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Line_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Line_name_feature", "_UI_Line_type"),
						MNetworkPackage.Literals.LINE__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Line_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Line_type_feature", "_UI_Line_type"),
						MNetworkPackage.Literals.LINE__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addStationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Line_stations_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Line_stations_feature", "_UI_Line_type"),
						MNetworkPackage.Literals.LINE__STATIONS, true, false, true, null, null, null));
	}
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MNetworkPackage.Literals.LINE__LENGTH, true, false, false,
	...
	protected void addTopologyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Line_topology_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Line_topology_feature", "_UI_Line_type"),
						MNetworkPackage.Literals.LINE__TOPOLOGY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
